import { SubCriteriaAction } from '@/components/molecules/criteria'
...
export const SubCriteriaTable = () => {
  const statusOptions = ['active', 'inactive', 'pending', 'deleted']

  const [data, setData] = useState<SubCriteriaData[]>([
    {
